...
// Passed returns true if the query was considered to have passed.
func (q QueryResult) Passed() bool {

	// When a query result contains a message, this means that
	// a rule succeeded and a policy was violated.
	// Successful queries do not contain a message.
	for _, queryResult := range q.Results {
